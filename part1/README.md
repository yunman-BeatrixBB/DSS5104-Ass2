...
## Deliverables for Member D
1. `results/classical_for_comparison.csv` - Standardized data for Transformer comparison
2. `results/figures/*_learning_curves.png` - Learning curve visualizations
3. `results/*_best_errors.csv` / `results/*_worst_errors.csv` - Misclassified case samples
4. All test set performance tables (including mean ± standard deviation)
