"""
DistilBERT AG-News Experiment Visualization
=============================================
Reads distilbert_agnews.json + efficiency_detail_distilbert.json
Outputs 6 PNG figures to the specified output directory.

Usage:
    python plot_distilbert_agnews.py
"""
...
MAIN_JSON = os.path.join(BASE, r"server_output_distibert_agnews\results\distilbert_agnews.json")
EFF_JSON  = os.path.join(BASE, r"server_output_distibert_agnews\results\efficiency_detail_distilbert\efficiency_detail_distilbert.json")
OUT_DIR   = os.path.join(BASE, r"output_distilbert_agnews")
...
dataset    = main.get("dataset", "agnews")
...
if __name__ == "__main__":
    print(f"\n{'='*50}")
    print(f"  DistilBERT AG-News Visualization")
